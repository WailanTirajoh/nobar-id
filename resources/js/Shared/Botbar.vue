<template>
  <div class="w-full">
    ...
    <section
      ...
      class="block fixed inset-x-0 bottom-0 z-10 bg-gray-800 shadow-inner border-t-2 border-gray-700"
    >
      <div id="tabs" class="flex justify-between">
        ...
        >
          <floating>
            ...
            <span class="tab tab-whishlist block text-xs"> WatchList </span>
          </floating>
        </Link>
        <Link
          :href="route('front.explore.index')"
          class="
            w-full
            hover:text-white hover:no-underline
            justify-center
...
import { HomeIcon, BellIcon, UserIcon } from 'vue-feather-icons'
export default {
  components: {
    Floating,
    HomeIcon,
